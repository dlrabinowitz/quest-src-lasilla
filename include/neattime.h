...
EXTERN double get_date_time(struct tm *tm);/* return UT date from system clock */
...
EXTERN int advance_tm_day(struct tm *tm);
EXTERN int leap_year_check(int year);
