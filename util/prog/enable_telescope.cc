...
int main(int argc, char *argv[]) {
    ...
    switch (status) {
    case 0:
        cout << "enable_telescope: telescope ready" << endl;
        break;
    case 1:
        cout << "enable_telescope: could not take control of telescope" << endl;
        break;
    case -1:
        cout << "enable_telescope: could not communicate with telescope" << endl;
        break;
    default:
        cout << "enable_telescope: unknown response from telescope: " << status
	     << endl;
        break;
    }
    if (status != 0) {
    ...
    status = telescope->enable_servos();
    switch (status) {
    case 1:
        cout << "enable_telescope: could not enable servos" << endl;
        break;
    case 0:
        cout << "enable_telescope: servos now enabled" << endl;
        break;
    case -1:
        cout << "enable_telescope: could not communicate with telescope" << endl;
        break;
